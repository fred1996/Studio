var homeMain = {
    ...
    dataTemplate: {
        'SEND_MSG': '<img src="../../Image/images/face.png" style="vertical-align: middle;width:25px;height:25px;" onclick="" class="face-set" /> <span class="to-user" touserid="0" data-bind="text:OnlineData.ToSay">所有人</span><input type="text" id="SayingInputVal"  data-bind="textInput: OnlineData.SayWord" /><a id="btnSayingTo" href="javascript:void(0);" onclick="client.events.sendMsgClick();">发送</a><div class="clear"></div>'
         ...
         , 'PERMISSION_POPUP': '<div id="roomboxc" class="hidden permission-list roombox" > <ul style="color:#333;padding:0px;margin:0px;"> <li onclick="homeMain.toSaying(\'#UserName#\',\'#UserID#\')" class="Hand">对他说</li> <li onclick="homeMain.kickRoom(\'#UserName#\',\'#UserID#\',3600)" class="Hand">禁言1小时</li> <li onclick="homeMain.joinBalckList(\'#UserName#\',\'#UserID#\',1)" class="Hand">封它IP</li><li onclick="homeMain.joinBalckList(\'#UserName#\',\'#UserID#\',2)" class="Hand">加入黑名单</li>  <li onclick="homeMain.kickRoom(\'#UserName#\',\'#UserID#\',300)" class="Hand">禁言5分钟</li> <li onclick="homeMain.recoveryPost (\'#UserName#\',\'#UserID#\')" class="Hand">恢复发言</li><li onclick="homeMain.DelBalckList (\'#UserID#\')" class="Hand">删除黑名单</li></ul></div>'
    },
    ...
    InitContext: function () {
        ...
        setTimeout(function () {
            ...
            homeMain.MarqueePlugin("jczs");
            homeMain.MarqueePlugin("zncx");
            homeMain.MarqueePlugin("gjjs");
            homeMain.MarqueePlugin("zwp");
        }, 2000);
        $(".columninfo").hover(function () {
    ...
    IreSize: function () {
        ...
        $("#MsgListWrapper").height($("#ChatMsgWrapper").height() - $("#ServiceQQs").height() - $("#ToolBarWapper").height() - $("#ClearToName").height() - $("#SayingInfoWrapper").height() - 80);
    ...
    MarqueePlugin: function (obj) {
        var roomScroll1 = new Marquee(obj);
        roomScroll1.Direction = 0;
        roomScroll1.Behavior = "scroll";
        //roomScroll.Step = 2;
        //roomScroll.Width = 166;
        //roomScroll1.Height = 102;
        roomScroll1.Timer = 40;
        roomScroll1.DelayTime = 0;
        roomScroll1.WaitTime = 0;
        roomScroll1.ScrollStep = 20;
        roomScroll1.Start();
    },
    TimerCollectGarbage: function () {
        window.setInterval("CollectGarbage();", 60000);
    },
};
$(function () {
