    ...
    public class ChatMessageCache
    {
        ...
        private void InitMessages()
        {
            try
            {
                ...
                {
                    var sysChatMsgses = db.SysChatMsgses.Where(t => t.RoomID == UntilHelper.RoomId&&t.MsgType==100).OrderByDescending(t => t.SendTime).Take(300).ToList();
        ...
        private static ChatMessageCache _instance;
        ...
        public static ChatMessageCache Instance
        {
            get
            {
                lock (SyncObj)
                {
                    if (_instance == null)
                    {
                        _instance = new ChatMessageCache();
                    }
                }
                return _instance;
            }
